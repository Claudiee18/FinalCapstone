...
function App() {
  useEffect(() => {
    ...
    const image = L.imageOverlay('C:/Users/admin/Capstone.srcimages/FinalMapMap.jpg', bounds).addTo(map);
    map.fitBounds(bounds);

    // Keep all your existing data objects (markersData, routesData) as they are
