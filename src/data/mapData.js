export const markersData = {
  "gate1": { 
    position: [521, 160],
    name: "Gate 1",
    image: "src/BuildingImages/Gate1.jpg" 
  },
  "Gate2": {  
    position: [320, 590],
    name: "Gate 2",
    image:"src/BuildingImages/Gate2.jpg"
   },
  ...
  "Bagobo Building": { 
    position: [650, 1345],
    name: "Bagobo",
    image:"src/BuildingImages/Bagobo.jpg" },

  "Badjao Building": {
    position: [512, 1670],
    name: "Badjao",
    image:"src/BuildingImages/Badjao.jpg" },


  "Benitez": { 
    position: [500, 690],
    name: "Benitez",
    image:"src/BuildingImages/Benitez1.jpg"
   },

  "Campus Ministry": { 
    position: [823, 520],
    name: "Campus Ministry",
    image:"src/BuildingImages/CampusMinistry.jpg"
   },

  "Canteen": { 
    position: [734, 898],
    name: "Cateen",
    image:"src/BuildingImages/Canteen.jpg" },

  "Clinic/Health Center": { 
    position: [810, 945],
    name: "Clinic",
    image:"src/BuildingImages/Clinic.jpg" },

  "Front Lawn": { 
    position: [440, 430],
    name: "Front Lawn",
    image:"src/BuildingImages/FrontLawn.jpg"
   },

  "FCB": { 
    position: [950, 1240],
    name: "FCB",
    image:"src/BuildingImages/FCB.jpg"
   },

  "Food Processing Inovation Center": { 
    position: [410, 1350],
    name: "Food Processing Center",
    image:"src/BuildingImages/FoodProcessing.jpg" },


  "JHS HE LAB": { 
    position: [818, 630],
    name: "JHS HE LAB",
    image:"src/BuildingImages/JHSHE.jpg" },

  "Juna Building": { 
    position: [670, 529],
    name: "Juna Building",
    image:"src/BuildingImages/Juna.jpg" },

  "Kalagan": { 
    position: [755, 1035],
    name: "Kalagan",
    image:"src/BuildingImages/Kalagan.jpg" },

  "Matigsalog Building": {
     position:[850, 435],
     name: "Matigsalog Building",
     image:"src/BuildingImages/Matigsalog.jpg" },

  "Maranao Building": { 
    position: [970, 490],
    name: "Maranao Building",
    image:"src/BuildingImages/Maranao.jpg" },

  "Maguindanao Building": { 
    position: [1030, 590],
    name: "Maguidanao Building",
    image:"src/BuildingImages/Maguindanao.jpg" },

  "Mansaka Building": { 
    position: [880, 720],
    name: "Mansaka Building",
    image:"src/BuildingImages/Mansaka.jpg"
  },

  "Mandaya Building": { 
    position: [900, 890],
    name:"Mandaya Building",
    image: "src/BuildingImages/Mandaya.jpg"
   },

  "Make Shift Classroom": { 
    position: [675, 1000],
    name: "Make Shift Building",
    image:"src/BuildingImages/MakeShift.jpg" },

  "Pavilion": { position: [570, 880] ,
                name: "Pavilion",
                image: "src/BuildingImages/Pavilion.jpg"
  },

  "PlayGround": { 
    position: [480, 1400],
    name: "Playground",
    image:"src/BuildingImages/Playground.jpg" },

  "Motor Pool": { 
    position: [120, 1150],
    name: "Motor Pool",
    image:"src/BuildingImages/MotorPool.jpg" },

  "RSM": { 
    position: [660, 250],
    name:"RSM Event Center",
    image:"src/BuildingImages/RSM1.jpg"
   },

  "Scouting Room": { 
    position: [595, 1520],
    name: "Scouting Room",
    image:"src/BuildingImages/Scouting.jpg" },

  "T'boli Building": { 
    position: [900, 375],
    name: "T'boli Building",
    image:"src/BuildingImages/Tboli.jpg" }
